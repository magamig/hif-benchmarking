...
````
@mastersthesis{da2022hyperspectral,
  title={Hyperspectral image fusion--a comprehensive review},
  author={da Lomba Magalh{\~a}es, Miguel Jorge},
  year={2022},
...
| *[Kennedy Space Center](https://aviris.jpl.nasa.gov/)* | 1996 | 1 | 512x614x176 [400,2500]nm*** | [URL](http://www.ehu.es/ccwintco/uploads/2/26/KSC.mat) | [AVIRIS NASA](http://aviris.jpl.nasa.gov/). Information about removed bands unavailable. |
...
| *[Botswana](http://www.ehu.eus/ccwintco/index.php/Hyperspectral_Remote_Sensing_Scenes)* | 2001 | 1 | 1476x256x145 [400,2500]nm*** | [URL](http://www.ehu.es/ccwintco/uploads/7/72/Botswana.mat) | [AVIRIS NASA](http://aviris.jpl.nasa.gov/). Information about removed bands is incorrect. |
...
| MSDCNN * | 2017 | [Python](https://github.com/hw2hwei/SSRNET) | [Yuan, Q., Wei, Y., Meng, X., Shen, H., & Zhang, L. (2018). A multiscale and multidepth convolutional neural network for remote sensing imagery pan-sharpening. IEEE Journal of Selected Topics in Applied Earth Observations and Remote Sensing, 11(3), 978-989.](https://arxiv.org/pdf/1712.09809.pdf) |
...
| SSF-CNN & PDCon-SSF * | 2018 | [Python](https://github.com/hw2hwei/SSRNET) | [Han, X. H., Shi, B., & Zheng, Y. (2018, October). SSF-CNN: Spatial and spectral fusion with CNN for hyperspectral image super-resolution. In 2018 25th IEEE International Conference on Image Processing (ICIP) (pp. 2506-2510). IEEE.](http://www.jdl.link/doc/2011/2019110_08451142.pdf) |
| STEREO | 2018 | [Matlab](https://github.com/marhar19/HSR_via_tensor_decomposition) | [Kanatsoulis, C. I., Fu, X., Sidiropoulos, N. D., & Ma, W. K. (2018). Hyperspectral super-resolution: A coupled tensor factorization approach. IEEE Transactions on Signal Processing, 66(24), 6503-6517.](https://arxiv.org/pdf/1804.05307.pdf) |
...
| TFNet & ResTFNet * | 2020 | [Python](https://github.com/hw2hwei/SSRNET) | [Liu, X., Liu, Q., & Wang, Y. (2020). Remote sensing image fusion based on two-stream fusion network. Information Fusion, 55, 1-15.](https://www.sciencedirect.com/science/article/pii/S1566253517308060) |
