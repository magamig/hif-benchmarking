function [PSNR,RMSE,SAM,SSIM, Z3d] = SRLRTS_sm(RZ2d,rzSize,sf,par,X,Y,H,P,kernel_type)
...
%           Li{i} = Groups{i};
    ...
    if PSNR - PSNR_last <0.001      %0.003,0.001 at first
        to = to + 1;
    else
        to = 0;
    end
...
SAM = hyperErrSam(RZ2d,Z);
SSIM = GetSSIMofHSI(RZ2d,Z,rzSize(1),rzSize(2));
