...
@LastEditors: zhengke
@LastEditTime: 2020-07-20 06:44:47
@Description: based model
@FilePath: \DeformatedHyperImageFusion\model\base_model.py
"""
...
class BaseModel:
    ...
    def setup(self, opt, parser=None):
        if self.isTrain:
            self.schedulers = [
                network.get_scheduler(optimizer, opt) for optimizer in self.optimizers
            ]
